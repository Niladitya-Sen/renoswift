        ...
        <div className='space-y-6'>
            ...
            <div className='my-4 grid grid-cols-2 max-w-sm w-full'>
                <Link href={"/admin/users/customers"} className={cn('border-b-2 pb-1 pl-1 text-gray-500 font-medium', {
                    'border-primary text-primary': pathname === '/admin/users/customers'
                })}>Customers</Link>
                <Link href={"/admin/users/operations-team"} className={cn('border-b-2 pb-1 pl-1 text-gray-500 font-medium', {
                    'border-primary text-primary': pathname.includes('/admin/users/operations-team')

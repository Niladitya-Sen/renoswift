            ...
            <Table>
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell>
                            <Link href={`/customer/rfqs/received-quotation/RS00R219`} className={'px-4 py-2 rounded-lg border-blue-500 border-2 text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-200'}>View</Link>
                        </TableCell>
                    </TableRow>
                </TableBody>
            </Table>
